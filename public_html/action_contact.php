...
$message .= "<tr style='background: #eee;'><td colspan='2'><a href='http://www.steelsalesonline.com/' target='_blank'>
<img src='http://www.steelsalesonline.com/img/logo.png'  width='650px'></a>
<a href='http://www.steelsalesonline.com/' target='_blank' style='text-decoration:none;'><strong><center>www.steelsalesonline.com</center></strong> </a></td></tr>";
$message .= "<tr><td colspan='2' align='center'>&nbsp;</td></tr>";	
$message .= "<tr><td colspan='2' style='text-decoration:none;'>Product Enquiry Details - www.steelsalesonline.com</td></tr>";	
...
$message .= "<tr><td  width='20%'><strong>Mobile No</strong> </td><td width='80%'>".strip_tags($_POST['phone'])."</td></tr>";
...
$Subject = "Product Enquiry Details - www.steelsalesonline.com";
// send email 
 $success = mail($EmailTo, $Subject, $message, "From: $headers") or die(" not send");
if($success){ echo "<script>window.location='index.html'</script>";}
 } else {
